                ...
                <div className="grid grid-cols-2 gap-8 md:grid-cols-4 lg:gap-12">
                    ...
                    <div>
                        ...
                        <ul className="space-y-2.5 text-sm">
                            ...
                            <li><Link href="/playground" className="text-muted-foreground hover:text-foreground transition-colors">Playground</Link></li>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2.5 text-sm">
                            ...
                            <li><Link href="https://github.com/codewithveek/fluxmedia" className="text-muted-foreground hover:text-foreground transition-colors">GitHub</Link></li>
                            <li><Link href="https://www.npmjs.com/package/@fluxmedia/core" className="text-muted-foreground hover:text-foreground transition-colors">NPM</Link></li>
                        </ul>
                    </div>
                    <div>
                        ...
                        <ul className="space-y-2.5 text-sm">
                            ...
                            <li><Link href="/license" className="text-muted-foreground hover:text-foreground transition-colors">MIT License</Link></li>
                        </ul>
                    </div>
                </div>
