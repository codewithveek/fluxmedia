            ...
            <div className="terminal-window">
                ...
                <div className="p-5">
                    <div
                        ...
                        dangerouslySetInnerHTML={{ __html: oldHtml || "<div class='text-muted-foreground'>Loading...</div>" }}
                    />
                </div>
            </div>
                ...
                <div className="p-5">
                    ...
                    <div className="flex gap-2 mb-4">
                        <button
                            ...
                            className={`px-3 py-1.5 text-xs font-medium rounded-md transition-all ${activeTab === "plugins"
                        ...
                        <button
                            ...
                            className={`px-3 py-1.5 text-xs font-medium rounded-md transition-all ${activeTab === "basic"
                                ? "bg-brand text-[#060609]"
                                : "bg-accent text-muted-foreground hover:text-foreground"
                            }`}
                        >
                    ...
                    <div className="relative">
                        <AnimatePresence mode="wait">
                            <motion.div
                                ...
                                dangerouslySetInnerHTML={{ __html: currentHtml || "<div class='text-muted-foreground'>Loading...</div>" }}
                            />
                        </AnimatePresence>
