...
const features = [
    {
        title: "Unified API",
        description: "One interface for all providers. Use Cloudinary, S3, or R2 with the same clean, type-safe API.",
        icon: Layers,
    ...
    },
    {
        ...
        description: "Built with strict types for incredible DX. Full autocomplete for provider configs.",
        icon: Code2,
    },
    {
