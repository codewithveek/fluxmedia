...
import { type FluxMediaPlugin, type UploadOptions, MediaError, MediaErrorCode } from '@fluxmedia/core';
...
export function createRetryPlugin(options: RetryOptions = {}): FluxMediaPlugin {
    const config: Required<Omit<RetryOptions, 'shouldRetry' | 'onRetry'>> & Pick<RetryOptions, 'shouldRetry' | 'onRetry'> = {
