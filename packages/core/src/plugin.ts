import type { UploadOptions, UploadResult, TransformationOptions } from './types';
...
export interface PluginHooks {
     ...
     * Can handle errors or rethrow.
     */
    onError?: (error: Error, context: { file: File | Buffer; options: UploadOptions }) => Promise<void>;
